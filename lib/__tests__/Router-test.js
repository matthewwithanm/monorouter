...
var reactEngine = require('../reactEngine.js');
...
describe('A Router instance', function() {
  ...
  it('cancels pending requests', function(done) {
    ...
    var Router = monorouter({engine: reactEngine})
    ...
    monorouter.renderInto(Router, div, {history: history});
